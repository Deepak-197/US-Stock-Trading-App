...
import ToggleSellBuy from './ToggleSellBuy';




export const SellModel = ({stockName}) => {
    ...
    return (
        ...
        <>
        <ChakraProvider>
            <Button onClick={onOpen} colorScheme={"#4201CD"} color={"white"}>SELL</Button>
            ...
            <Modal closeOnOverlayClick={false} isOpen={isOpen} onClose={onClose}>
                ...
                <ModalContent w={"700px"} mt={100}>
                    ...
                    <ModalCloseButton />
                    <ModalBody pb={6}>
                      <ToggleSellBuy header={stockName} />
                      <hr />
                        <Tabs>
                            <TabList >
